    ...
    <main class="page-content content-wrap">
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <div class="logo-box">
                    <a href="{{route('ViewAdminDashboard')}}" class="logo-text"><span>UKMP</span></a>
                </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                    <span class="user-name">{{Auth::guard('admin')->user()->username}}<i class="fa fa-angle-down"></i></span>
...
{{--                             <div class="sidebar-profile-image">
                            ...
                            <div class="sidebar-profile-details">
                                <span>Admin<br><small>UKM Picker</small></span>
                            </div>
                        </div>
                    </div>
                    <ul class="menu accordion-menu">
                        ...
                        {{ (request()->routeIs(
                            ...
                            ">
                            <a href="{{route('ViewAdminDashboard')}}" class="waves-effect waves-button">
                        ...
                        {{ (request()->routeIs(
                            ...
                            <ul class="sub-menu">
                                ...
                                {{ (request()->routeIs(
                                    ...
                                    ">
                                    <a href="{{route('ViewAdminShowUkm')}}">Show Data</a>
                                </li>
                                <li class="
                                {{ (request()->routeIs(
                                    ...
                                    ">
                                    <a href="{{route('ViewAdminTambahUkm')}}">Tambah Data</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        {{ (request()->routeIs(
                            ...
                            'ViewAdminShowPengurus',
                            'ViewAdminTambahPengurus'
                            ...
                            <ul class="sub-menu">
                                ...
                                {{ (request()->routeIs(
                                    ...
                                    ">
                                    <a href="{{route('ViewAdminShowPengurus')}}">Show Data</a>
                                </li>
                                <li class="
                                {{ (request()->routeIs(
                                    ...
                                    ">
                                    <a href="{{route('ViewAdminTambahPengurus')}}">Tambah Data</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        {{ (request()->routeIs(
                            ...
                            'ViewAdminShowMahasiswa',
                            'ViewAdminTambahMahasiswa'
                            ...
                            <ul class="sub-menu">
                                ...
                                {{ (request()->routeIs(
                                    ...
                                    ">
                                    <a href="{{route('ViewAdminShowMahasiswa')}}">Show Data</a>
                                </li>
                                <li class="
                                {{ (request()->routeIs(
                                    ...
                                    ">
                                    <a href="{{route('ViewAdminTambahMahasiswa')}}">Tambah Data</a>
                                </li>
                            </ul>
                        </li>
