    ...
    <main class="page-content content-wrap">
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <div class="logo-box">
                    <a href="{{route('ViewMahasiswaDashboard')}}" class="logo-text"><span>Mahasiswa</span></a>
                </div>
...
{{--                             <div class="sidebar-profile-image">
                            ...
                            <div class="sidebar-profile-details">
                                <span>Mahasiswa<br><small>UKM Picker</small></span>
                            </div>
                        </div>
                    </div>
                    <ul class="menu accordion-menu">
                        ...
                        {{ (request()->routeIs(
                            ...
                            ">
                            <a href="{{route('ViewMahasiswaDashboard')}}" class="waves-effect waves-button">
